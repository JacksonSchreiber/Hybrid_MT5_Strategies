...
mkdir -p "$SETDIR"
{
  ...
  echo "InpShowEvents=true"       # event lines ON for the trader; toggle COACH MODE in the
                                  # popup to hide them for the blind-advisor screenshot (they
                                  # print currency+event name, which would otherwise leak).
