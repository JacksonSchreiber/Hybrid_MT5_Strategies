...
pipeline/live_selftest.sh --selftest --poll 20 --symbol EURUSD.dk --from 2024.01.01 --to 2024.06.30 --timeout 1200 2>&1 | grep -E 'finished|signals:|tasks pending|journal rows|WARN'
